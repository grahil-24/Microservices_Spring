package com.rahil.microservices.currencyconversionservice.controller;

import com.rahil.microservices.currencyconversionservice.model.CurrencyConversion;
import com.rahil.microservices.currencyconversionservice.proxy.CurrencyExchangeProxy;
...
//to integrate resttemplate with micrometer, we need to use resttemplatebuilder
...
public class CurrencyConversionController {
    ...
    public CurrencyConversion calcaulateCurrencyConversion(@PathVariable String from,
    ...
    public CurrencyConversion calcaulateCurrencyConversionFeign(@PathVariable String from,
                                                           @PathVariable String to, @PathVariable BigDecimal quantity){
